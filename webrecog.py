...
__author__ = 'Rohith R Nair - www.programmersleague.com'
...
class WebRecog(ModelLoader):
    def __init__(self, input_shape, output_size, output_path):
        ModelLoader.__init__(self, input_shape, output_size, output_path)
        self.name = "webrecognition"
